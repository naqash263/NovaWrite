      ...
      <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8">
        ...
        <div className="space-y-6 mt-8">
          ...
          <div className="p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg">
            <h3 className="text-2xl font-bold text-gray-900 mb-3">About Base64 Encoder & Decoder</h3>
          ...
          <div className="p-6 bg-white border border-gray-200 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h5 className="font-semibold text-gray-900 mb-1">UTF-8 Support</h5>
          ...
          <div className="p-6 bg-blue-50 rounded-lg">
            ...
            <div className="space-y-4">
              <div>
                <h5 className="font-semibold text-gray-900 mb-2">What is Base64 encoding?</h5>
              ...
              <div>
                <h5 className="font-semibold text-gray-900 mb-2">Does this support UTF-8?</h5>
                <p className="text-gray-700 text-sm">
