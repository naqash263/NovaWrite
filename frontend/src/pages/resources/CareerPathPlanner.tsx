  ...
  const generateCareerPlan = async () => {
    ...
    try {
      ...
      const response = await fetchWithTimeout(
        `${import.meta.env.VITE_API_URL || 'http://localhost:8001/api'}/career-tools/career-path/generate`,
        {
          method: 'POST',
          headers,
          body: JSON.stringify({
        ...
        <div className="text-center mb-8">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-8 max-w-4xl mx-auto">
            ...
            <p className="text-yellow-600 text-center">
              Check back soon for the complete career path planning experience!
            </p>
          </div>
