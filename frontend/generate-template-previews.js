...
async function generateTemplatePreviews() {
  ...
  for (const templateName of templates) {
    ...
    const style = { ...defaultStyle, templateName };
...
<body>
    ...
    <script type="module">
        ...
        function generateTemplateHTML(template, data, style) {
            const sectionTitleStyle = \`color: \${style.primaryColor}; border-color: \${style.primaryColor}; font-size: \${style.fontSize * 1.1}px\`;
            
            if (template === 'Classic') {
                return \`
                    <div class="max-w-[210mm] min-h-[297mm] max-h-[594mm] p-6 space-y-3" style="font-family: \${style.fontFamily}">
                        <header class="text-center">
                            <h1 class="text-3xl font-bold" style="color: \${style.primaryColor}; font-size: \${style.fontSize * 2}px">\${data.fullName}</h1>
                            <p class="text-lg mt-1" style="color: \${style.primaryColor}; font-size: \${style.fontSize * 1.1}px">\${data.jobTitle}</p>
                        </header>
                ...
                return \`
                    <div class="max-w-[210mm] min-h-[297mm] max-h-[594mm] p-6 space-y-3" style="font-family: \${style.fontFamily}">
                        <header class="flex items-center space-x-4" style="background-color: \${style.primaryColor}; color: \${style.secondaryColor}; padding: 1rem;">
                            <div class="flex-1">
                                <h1 class="text-3xl font-bold" style="color: \${style.secondaryColor}; font-size: \${style.fontSize * 2}px">\${data.fullName}</h1>
                                <p class="text-lg mt-1" style="color: \${style.secondaryColor}; font-size: \${style.fontSize * 1.1}px">\${data.jobTitle}</p>
